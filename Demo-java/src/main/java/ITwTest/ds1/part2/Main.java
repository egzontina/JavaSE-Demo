...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("nombre d'animaux pr�sents dans ce refuge CHIEN : " + refugeChien.getNombreAnimauxDuRefuge());
		...
		*/
		...
		System.out.println("nombre d'animaux pr�sents dans ce refuge CHAT : " + refugeChat.getNombreAnimauxDuRefuge());
