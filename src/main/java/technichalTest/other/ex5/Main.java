...
public class Main {
	...
	public static void main(String[] args) {
		/*
		 * When list declared, I still can add to ArrayList new elements, remove elements and update it.
		 * 	when an array is declared as final, the state of the object stored in the array can be modified
		 */
	 ...
	 * This means that i cannot rebind the variable to point to a different collection instance
	 */
	...
	// if If i wish, you can prevent insertion, removal etc by using Collections.unmodifiableList()
	...
	System.out.println("list2 add() : " + list2);
	 ...
	 /* Which advantages/disadvantages we can get by making ArrayList (or other Collection) final?
	 */
